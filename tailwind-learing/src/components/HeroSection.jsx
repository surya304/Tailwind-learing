...
export default function HeroSection() {
  ...
  return (
    <div >
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 bg-dark-background" >
        <div
        ...
        <div className="mx-auto max-w-2xl pb-32 sm:pb-48 lg:pb-56">
          ...
          <div className="text-center">
            <h1 className="text-[10rem] font-bold tracking-tight sm:text-6xltext-white">
            Hi. I'm Sai Surya.


            </h1>
            <p className="mt-6 text-4xl leading-8 text-white">
